 ...
 * que est‡n relacionadas mediante una relaci—n uno a muchos
 * @author Santiago Faci
 * @version 1.0
 */

public class RelacionesHibernate2 {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					RelacionesHibernate2 window = new RelacionesHibernate2();
