...
public class JPersonaje extends JDialog {
	...
	public Arma getArma() {
		return comboArma.getArmaSeleccionada();
	}
	
	public void setArma(String arma) {
		this.comboArma.setSelectedItem(arma);
	}
	...
	private void aceptar() {
		...
		try {
			...
			arma = (String) comboArma.getSelectedItem();
	...
	public JPersonaje() {
		...
		comboArma = new JComboArma();
		inicializar();
		comboArma.setBounds(100, 146, 138, 27);
		contentPanel.add(comboArma);
		{
